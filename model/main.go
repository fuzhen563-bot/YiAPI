...
func migrateDB() error {
	...
	if err = DB.AutoMigrate(&TokenPlan{}); err != nil {
		return err
	}
	...
	if err = DB.AutoMigrate(&UserRiskConfig{}); err != nil {
		return err
	}
	if err = DB.AutoMigrate(&DailyUsage{}); err != nil {
		return err
	}
	if err = DB.AutoMigrate(&AffiliateCommission{}); err != nil {
		return err
	}
	if err = DB.AutoMigrate(&UserResourcePack{}); err != nil {
		return err
	}
